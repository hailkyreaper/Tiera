...
// Desktop sidebar — same 4 destinations as the mobile bar (Create is its own
// CTA below, not a nav item here). Library/Lists/Settings were dropped from
// here: Library is reached the same way mobile reaches it, via ProfileTabs'
// own Lists/Library toggle inside the Profile page itself, and Settings has
// no dedicated page (Edit Profile/Log out already live inline on Profile).
